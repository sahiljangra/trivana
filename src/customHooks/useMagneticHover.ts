...
const useMagneticHover = (): void => {
  useEffect(() => {
    const handleMouseMove = (event: MouseEvent) => {
      const magneticItems = document.querySelectorAll<HTMLElement>(".magnetic-item");
    ...
    const handleMouseEnter = (_event: MouseEvent) => {
      const item = document.querySelector<HTMLElement>(".magnetic-item");
      if (item) {
