                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="footer-logo-area">
                                    <Link href="/engineering" className="footer-logo">
                                        <Image width={160} height={95} src="/assets/img/footer-logo2.svg" alt="" />
                                    </Link>
                ...
                <div className="container">
                    <div className="footer-bottom">
                        <div className="copyright-area">
                            <p>Copyright 2025 <Link href="/engineering">Matrik</Link> | Design By <a href="https://www.egenslab.com/">Egens Lab</a></p>
                        </div>
                    </div>
                </div>
            </div>
