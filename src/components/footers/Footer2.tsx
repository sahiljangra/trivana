                        ...
                        <div className="row g-4 align-items-center">
                            <div className="col-md-3">
                                <Link href="/industry" className="footer-logo">
                                    <Image width={160} height={99} src="/assets/img/footer-logo.svg" alt="" />
                                </Link>
                            </div>
                ...
                <div className="container">
                    <div className="footer-bottom">
                        <div className="copyright-area">
                            <p>Copyright 2025 <Link href="/industry
                            ">Matrik</Link> | Design By <a href="https://www.egenslab.com/">Egens Lab</a></p>
                        </div>
