...
import website from "@/data/static-data";
...
const Header1: React.FC = () => {
    ...
    const productspaths: string[] = [
        ...
        "/products/bath-mats",
        "/products/towels",
        "/products/pouf-and-cushions",
        "/products/area-rugs",
        "/products/scattered-rugs",
        "/products/baskets",
        "/products/braided-rugs",
        "/products/bags-and-accessories",
        "/products/placemats",
        "/products/throws",
    ];
    const isSproductsPathActive: boolean = productspaths.some((path: string) => pathname.startsWith(path));
                ...
                <div className="right-sidebar-menu-wrap">
                    <div className="sidebar-logo-area d-flex justify-content-between align-items-center">
                        <div className="sidebar-logo-wrap">
                            <Link href="/">
                                <Image width={157} height={34} alt="image" src="/assets/img/header-logo.svg" />
                            </Link>
                        </div>
                    ...
                    <div className="sidebar-content-wrap">
                            ...
                            <li>
                                <div className="single-contact">
                                    ...
                                    <div className="content">
                                        ...
                                        <h6>
                                            <a href={`tel:${website.phone}`}>{website.displayPhone}</a>
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div className="single-contact social">
                                    ...
                                    <div className="content">
                                        <span>Follow Us</span>
                                        <h6>
                                            <a href="https://www.facebook.com/">Facebook,</a> <a href="https://www.linkedin.com/">LinkedIn,</a>{" "}
                            ...
                            <li>
                                <div className="single-contact">
                                    ...
                                    <div className="content">
                                        <span>SAY HELLO</span>
                                        <h6>
                                            <a href="mailto:info@trivanatextile.com">info@trivanatextile.com</a>
                                        </h6>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul className="address-area">
                            <li className="single-address">
                                ...
                                <a href="#">Unit - 3, 1775 Sismet Rd, Mississauga, ON, L4W 1P9</a>
                            </li>
                            {/* <li className="single-address">
                    ...
                    <div className="sidebar-bottom-area">
                        <p>
                            Copyright 2025 <Link href="/">Trivana</Link>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
                    ...
                    <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
                        ...
                        <ul className="menu-list">
                            ...
                            <li className={`menu-item-has-children  ${isSproductsPathActive ? "active" : ""}`}>
                                <Link href="/products" className="drop-down">
                                    Products
                                ...
                                <i
                                    ...
                                    className={`bi bi-${state.activeMenu === "products" ? "dash" : "plus"} dropdown-icon`}
                                />
