...
const Header6: React.FC = () => {
  ...
  const homePaths = ["/", "/industry", "/oil-gas", "/metal-industry", "/textile", "/engineering"];
  const isHomeActive = homePaths.some((path) => (path === "/" ? pathname === "/" : pathname.startsWith(path)));
  ...
  const isInnerPagePathActive = innerPagePaths.some((path) => pathname.startsWith(path));
    return (
        <>
            ...
            <div className={`header-topbar-wrap header-area ${state.scrollY > 20 ? "sticky" : ""}`}>
                ...
                <header className="style-1 engineering-header">
                    <div className="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
                        <div className="company-logo">
                            <Link href="/"><Image width={157} height={34} alt="image" className="img-fluid" src="/assets/img/header-logo-white.svg" /></Link>
                        </div>
