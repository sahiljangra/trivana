        ...
        <>
            <div className="sidebar-wrapper header-area">
                <div className="sidebar-logo">
                    <Link href="/metal-industry"><Image width={55} height={35} src="/assets/img/header-logo2.svg" alt="" /></Link>
                </div>
                ...
                <div className="sidebar-menu-top-area">
                    <div className="container d-flex align-items-center justify-content-between">
                        <div className="sidebar-menu-logo">
                            <Link href="/metal-industry"><Image width={55} height={35} alt="image" className="img-fluid" src="/assets/img/header-logo.svg" /></Link>
                        </div>
                        ...
                        <div className="col-lg-8 order-lg-2 order-1">
                            <div className="sidebar-menu-wrap">
                                <ul className="main-menu">
                                    <li>
                                        <Link href="/">HOME</Link>
                                        <span onClick={() => toggleMenu("HOME")} className="dropdown-icon2 "><i className={`bi bi-${state.activeMenu === "HOME" ? "dash" : "plus"}`} /></span>
                                        <ul className={`submenu-list active ${state.activeMenu === "HOME" ? "d-block" : "d-none"}`}>
                                            <li>
                                                <Link href="/">Factory
                                            ...
                                            <li className="active">
                                                <Link href="/metal-industry">Metal Industry
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/engineering">Engineering
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                    ...
                                    <li>
                                        ...
                                        <span onClick={() => toggleMenu("solution")} className="dropdown-icon2 "><i className={`bi bi-${state.activeMenu === "solution" ? "dash" : "plus"}`} /></span>
                                        <ul className={`submenu-list active ${state.activeMenu === "solution" ? "d-block" : "d-none"}`}>
                                            <li>
                                                <Link href="/service">Services Style 01
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/service/style2">Services Style 02
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/service/style3">Services Style 03
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/service/style4">Services Style 04
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                    ...
                                    <li>
                                        ...
                                        <span onClick={() => toggleMenu("project")} className="dropdown-icon2 "><i className={`bi bi-${state.activeMenu === "project" ? "dash" : "plus"}`} /></span>
                                        <ul className={`submenu-list active ${state.activeMenu === "project" ? "d-block" : "d-none"}`}>
                                            <li>
                                                <Link href="/project/grid">Project Grid
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/project/metro">Project Metro
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/project/horizontal">Project Horizontal
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/project/infoflow">Project Infoflow
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/project/text-down">Project Text Down
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/project/single-slider">Project Single Slider
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                    ...
                                    <li>
                                        <a href="#">Pages</a>
                                        <span onClick={() => toggleMenu("pages")} className="dropdown-icon2"><i className={`bi bi-${state.activeMenu === "pages" ? "dash" : "plus"}`} /></span>
                                        <ul className={`submenu-list active ${state.activeMenu === "pages" ? "d-block" : "d-none"}`}>
                                            <li>
                                                <Link href="/our-team">Our Team
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                ...
                                                <span onClick={() => toggleSubMenu("product")} className="dropdown-icon2 two active"><i className={`bi bi-${state.activeSubMenu === "product" ? "dash" : "plus"}`} /></span>
                                                <ul className={`submenu-list active ${state.activeSubMenu === "product" ? "d-block" : "d-none"}`}>
                                                    <li>
                                                        <Link href="/product">Our Product
                                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                            </svg>
                                                        </Link>
                                                    ...
                                                    <li>
                                                        <Link href="/product/details">Product Details
                                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                            </svg>
                                                        </Link>
                                            ...
                                            <li>
                                                <Link href="/our-process">Our Process
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                <Link href="/our-clients">Our Clients
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                        <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    </svg>
                                                </Link>
                                            ...
                                            <li>
                                                ...
                                                <span onClick={() => toggleSubMenu("blog")} className="dropdown-icon2 two active"><i className={`bi bi-${state.activeSubMenu === "blog" ? "dash" : "plus"}`} /></span>
                                                <ul className={`submenu-list active ${state.activeSubMenu === "blog" ? "d-block" : "d-none"}`}>
                                                    <li>
                                                        <Link href="/blog">
                                                            Blog Grid
                                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                    ...
                                                    <li>
                                                        <Link href="/blog/sidebar">Blog Sidebar
                                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                            </svg>
                                                        </Link>
                                                    ...
                                                    <li>
                                                        <Link href="/blog/standard">Blog Standard
                                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                            </svg>
                                                        </Link>
                                            ...
                                            <li>
                                                ...
                                                <span onClick={() => toggleSubMenu("shop")} className="dropdown-icon2 two active"><i className={`bi bi-${state.activeSubMenu === "shop" ? "dash" : "plus"}`} /></span>
                                                <ul className={`submenu-list active ${state.activeSubMenu === "shop" ? "d-block" : "d-none"}`}>
                                                    <li>
                                                        <Link href="/shop">Shop
                                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                    ...
                                                    <li>
                                                        <Link href="/shop/details">Shop Details
                                                            <svg xmlns="http://www.w3.org/2000/svg" width={10} height={10} viewBox="0 0 10 10">
                                                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                            </svg>
                                                        </Link>
